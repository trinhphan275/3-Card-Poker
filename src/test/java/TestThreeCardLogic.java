...
public class TestThreeCardLogic {
    ...
    void isPairTest2() {
        ...
        deck2.add(card6);
        assertEquals(5, ThreeCardLogic.evalHand(deck));
        assertEquals(3, ThreeCardLogic.evalHand(deck2));
    }
    ...
    void isFlushTest2() {
        ...
        deck2.add(card5);
        deck2.add(card6);
        assertEquals(4, ThreeCardLogic.evalHand(deck2));
    }
    ...
    void threeOfAKindTest2() {
        ...
        deck2.add(card5);
        deck2.add(card6);
        assertEquals(2, ThreeCardLogic.evalHand(deck2));
    }
    ...
    void straightFlushTest2() {
        ...
        deck2.add(card5);
        deck2.add(card6);
        assertEquals(1, ThreeCardLogic.evalHand(deck2));
    }
